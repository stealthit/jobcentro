        ...
        return (
            <div className={styles.container}>
                <div class={[styles.tableBox,"contentBox"]}>
                    <div class="titleWrap"> 
                        <div class="title">파일관리  &gt; tenant01  &gt; resources  &gt; ff</div>                     
                        <div className="h-flex">
                            <div class={styles.btnGrp}>
                                ...
                                <button class="btnType1 btn-export">재업로드</button>
                                <button class="btnType1 btn-edit">이름 변경</button>
                                <button class="btnType1 btn-save">다운로드</button>
